...
import com.vergilyn.examples.junit.base.TestngRollbackBaseTest;
 ...
 * TestNG并发测试<br/>
 * <ul>
 *     <li>{@link AbstractTransactionalTestNGSpringContextTests}: 自动回滚事务。多数据源处理参考{@link TestngRollbackBaseTest}</li>
...
public class TestngApplicatonTest extends AbstractTestNGSpringContextTests {
    @Autowired
    ...
    public void testService(String username){
        ...
        List<TestUser> users = testService.get(username);
